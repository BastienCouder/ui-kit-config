...
<ComponentPreview name="demos/components/core/react/button/default" preview={`<Button>button</Button>`} extension={'tsx'} />
...
```
  ...
  <ComponentSource name={["components/core/default/react/button"]} extension={["tsx"]} />
...
<ComponentPreview
  name="demos/components/core/react/button/variants"
...
<ComponentPreview
  name="demos/components/core/react/button/sizes"
...
<ComponentPreview
  name="demos/components/core/react/button/shapes"
...
<ComponentPreview
  name="demos/components/core/react/button/prefix-and-suffix"
...
<ComponentPreview
  name="demos/components/core/react/button/loading"
...
<ComponentPreview
  name="demos/components/core/react/button/disabled"
...
<ComponentPreview
  name="demos/components/core/react/button/link-button"
