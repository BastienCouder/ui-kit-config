...
<ComponentPreview name="demos/components/core/date-picker/default" preview={`<DatePicker />`} />
...
<Step>Copy and paste the following code into your project.</Step>
  <ComponentSource
    name={[
      "components/core/default/date-picker",
...
<ComponentPreview
  name="demos/components/core/date-picker/label"
...
<ComponentPreview
  name="demos/components/core/date-picker/sizes"
...
<ComponentPreview
  name="demos/components/core/date-picker/prefix"
...
<ComponentPreview
  name="demos/components/core/date-picker/description"
...
<ComponentPreview
  name="demos/components/core/date-picker/contextual-help"
  preview={`<DatePicker label="Appointment" contextualHelp={<ContextualHelp />} />`}
/>
...
<ComponentPreview
  name="demos/components/core/date-picker/error-message"
  preview={`<DatePicker
  label="Meeting"
  isInvalid
...
<ComponentPreview
  name="demos/components/core/date-picker/time-zones"
...
<ComponentPreview
  name="demos/components/core/date-picker/granularity"
  preview={`<DatePicker
  label="Hour"
  granularity="hour"
...
<ComponentPreview
  name="demos/components/core/date-picker/placeholder"
...
<ComponentPreview
  name="demos/components/core/date-picker/hide-time-zone"
  preview={`<DatePicker
...
<ComponentPreview
  name="demos/components/core/date-picker/hour-cycle"
...
<ComponentPreview
  name="demos/components/core/date-picker/loading"
...
<ComponentPreview
  name="demos/components/core/date-picker/uncontrolled"
