...
<ComponentPreview
  name="demos/components/core/date-range-picker/default"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/label"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/sizes"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/prefix"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/description"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/contextual-help"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/error-message"
  preview={`<DateRangePicker
  label="Trip dates"
  isInvalid
...
<ComponentPreview
  name="demos/components/core/date-range-picker/time-zones"
  preview={`<DateRangePicker
  defaultValue={{
...
<ComponentPreview
  name="demos/components/core/date-range-picker/granularity"
...
<ComponentPreview
  name="demos/components/core/date-range-picker/placeholder"
